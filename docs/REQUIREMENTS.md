...
* **REQ-SB-03 [Kernel Programming]：** 系統需提供可選 Linux Kernel Module (`ops/kernel/sandbox_cgroup_audit.c`)，透過 procfs 暴露 sandbox cgroup v2 policy audit 資訊，作為宿主機端 kernel-space 稽核元件。
