...
from .models import User, Account, Transaction, Beneficiary, Idempotency
...
class DBOperations:
    ...
    @staticmethod
    def get_account_transactions(account_id: str, user_id: str, limit: int = 20) -> list[dict] | None:
    ...
    @staticmethod
    def create_beneficiary(user_id: str, nickname: str, bank_code: str, account_id: str, beneficiary_name: str) -> dict | None:
    ...
    @staticmethod
    def transfer_money(user_id: str, from_account: str, to_account: str, amount: float, fee: float, note: str) -> dict | None:
        ...
        try:
            ...
            from_acc = db.query(Account).filter(
                Account.account_id == from_account,
                Account.user_id == user_id
            ).first()
    ...
    def get_idempotent_transaction(user_id: str, idempotency_key: str) -> str | None:
        ...
        try:
            result = db.query(Idempotency).filter(
