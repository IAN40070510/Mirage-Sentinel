...
def build_attack_signatures() -> dict:
    ...
    base_signatures = {
        ...
        "tool_signatures": {
            ...
            "script_tags": ["cscript", "wscript", "jscript", "vbscript"],
            "exec": [
                "exec",
                "eval",
                "system",
...
def main():
    ...
    payloads_files = [
        ...
        (
            "https://raw.githubusercontent.com/swisskyrepo/PayloadsAllTheThings/master/Web%20Shell/README.md",
            "payloads/Web_Shell.md",
        ),
        (
            "https://raw.githubusercontent.com/swisskyrepo/PayloadsAllTheThings/master/Path%20Traversal/README.md",
            "payloads/Path_Traversal.md",
        ),
    ]
